...
// Ruta del archivo de transcripción (cambiar por tu archivo real)
...
if (!anthropicApiKey) {
  console.error('Error: No se encontró ANTHROPIC_API_KEY en las variables de entorno');
  process.exit(1);
}

console.log('Procesando transcripción con Claude...');

// Llamar al script Python
const scriptPath = path.join(__dirname, 'scripts', 'process_transcript_claude.py');
